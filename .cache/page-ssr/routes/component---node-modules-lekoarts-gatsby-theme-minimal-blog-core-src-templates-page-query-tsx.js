...
/** @jsx jsx */const Page=({data:{page}})=>(0,theme_ui_esm/* jsx */.tZ)(layout/* default */.Z,null,(0,theme_ui_esm/* jsx */.tZ)(seo/* default */.Z,{title:page.title,description:page.excerpt}),(0,theme_ui_esm/* jsx */.tZ)(theme_ui_components_esm/* Heading */.X6,{as:"h1",variant:"styles.h1"},page.title),(0,theme_ui_esm/* jsx */.tZ)("section",{sx:{my:5,variant:`layout.content`}},(0,theme_ui_esm/* jsx */.tZ)(gatsby_plugin_mdx.MDXRenderer,null,page.body)));/* harmony default export */ const page = (Page);
...
function MinimalBlogCorePage(_ref){let props=(0,esm_extends/* default */.Z)({},_ref);return/*#__PURE__*/index_js_.createElement(page,props);}
;// CONCATENATED MODULE: ./node_modules/@lekoarts/gatsby-theme-minimal-blog-core/src/templates/page-query.tsx
/* harmony default export */ const page_query = (MinimalBlogCorePage);const query="1594686464";
