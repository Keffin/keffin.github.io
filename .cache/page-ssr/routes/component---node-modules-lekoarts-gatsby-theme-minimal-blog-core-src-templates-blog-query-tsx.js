...
/** @jsx jsx */const Blog=({posts})=>{const{tagsPath,basePath}=(0,use_minimal_blog_config/* default */.Z)();return (0,theme_ui_esm/* jsx */.tZ)(layout/* default */.Z,null,(0,theme_ui_esm/* jsx */.tZ)(seo/* default */.Z,{title:"Blog"}),(0,theme_ui_esm/* jsx */.tZ)(theme_ui_components_esm/* Flex */.kC,{sx:{alignItems:`center`,justifyContent:`space-between`,flexFlow:`wrap`}},(0,theme_ui_esm/* jsx */.tZ)(theme_ui_components_esm/* Heading */.X6,{as:"h1",variant:"styles.h1",sx:{marginY:2}},"Blog"),(0,theme_ui_esm/* jsx */.tZ)(theme_ui_components_esm/* Link */.rU,{as:gatsby_browser_entry.Link,sx:{variant:`links.secondary`,marginY:2},to:(0,replaceSlashes/* default */.Z)(`/${basePath}/${tagsPath}`)},"View all tags")),(0,theme_ui_esm/* jsx */.tZ)(listing/* default */.Z,{posts:posts,sx:{mt:[4,5]}}));};/* harmony default export */ const blog = (Blog);
...
function MinimalBlogCoreBlog(_ref){let props=(0,esm_extends/* default */.Z)({},_ref);const{data:{allPost}}=props;return/*#__PURE__*/index_js_.createElement(blog,Object.assign({posts:allPost.nodes},props));}
