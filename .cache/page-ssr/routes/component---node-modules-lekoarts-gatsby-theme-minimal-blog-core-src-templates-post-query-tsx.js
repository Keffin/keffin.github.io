...
var gatsby_plugin_mdx = __webpack_require__(39394);
...
const PostFooter=({post})=>null;/* harmony default export */ const post_footer = (PostFooter);
;// CONCATENATED MODULE: ./node_modules/@lekoarts/gatsby-theme-minimal-blog/src/components/post.tsx
/** @jsx jsx */const px=[`32px`,`16px`,`8px`,`4px`];const shadow=px.map(v=>`rgba(0, 0, 0, 0.15) 0px ${v} ${v} 0px`);const Post=({data:{post}})=>{var _post$banner,_post$banner$childIma,_post$banner$childIma2;return (0,theme_ui_esm/* jsx */.tZ)(layout/* default */.Z,null,(0,theme_ui_esm/* jsx */.tZ)(seo/* default */.Z,{title:post.title,description:post.description?post.description:post.excerpt,image:post.banner?(_post$banner=post.banner)===null||_post$banner===void 0?void 0:(_post$banner$childIma=_post$banner.childImageSharp)===null||_post$banner$childIma===void 0?void 0:(_post$banner$childIma2=_post$banner$childIma.resize)===null||_post$banner$childIma2===void 0?void 0:_post$banner$childIma2.src:undefined,pathname:post.slug,canonicalUrl:post.canonicalUrl}),(0,theme_ui_esm/* jsx */.tZ)(theme_ui_components_esm/* Heading */.X6,{as:"h1",variant:"styles.h1"},post.title),(0,theme_ui_esm/* jsx */.tZ)("p",{sx:{color:`secondary`,mt:3,a:{color:`secondary`},fontSize:[1,1,2]}},(0,theme_ui_esm/* jsx */.tZ)("time",null,post.date),post.tags&&(0,theme_ui_esm/* jsx */.tZ)(index_js_.Fragment,null,` — `,(0,theme_ui_esm/* jsx */.tZ)(item_tags/* default */.Z,{tags:post.tags})),post.timeToRead&&` — `,post.timeToRead&&(0,theme_ui_esm/* jsx */.tZ)("span",null,post.timeToRead," min read")),(0,theme_ui_esm/* jsx */.tZ)("section",{sx:{my:5,".gatsby-resp-image-wrapper":{my:[4,4,5],boxShadow:shadow.join(`, `)},variant:`layout.content`}},(0,theme_ui_esm/* jsx */.tZ)(gatsby_plugin_mdx.MDXRenderer,null,post.body)),(0,theme_ui_esm/* jsx */.tZ)(post_footer,{post:post}));};/* harmony default export */ const post = (Post);
...
function MinimalBlogCorePost(_ref){let props=(0,esm_extends/* default */.Z)({},_ref);return/*#__PURE__*/index_js_.createElement(post,props);}
;// CONCATENATED MODULE: ./node_modules/@lekoarts/gatsby-theme-minimal-blog-core/src/templates/post-query.tsx
/* harmony default export */ const post_query = (MinimalBlogCorePost);const query="2145575470";
...
/* harmony import */ var theme_ui__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(17631);
 ...
 */const MDXRenderer=__webpack_require__(56660);module.exports={MDXRenderer:MDXRenderer};
...
var _defineProperty=__webpack_require__(59713);var _objectWithoutProperties=__webpack_require__(6479);const _excluded=["scope","children"];function ownKeys(object,enumerableOnly){var keys=Object.keys(object);if(Object.getOwnPropertySymbols){var symbols=Object.getOwnPropertySymbols(object);if(enumerableOnly){symbols=symbols.filter(function(sym){return Object.getOwnPropertyDescriptor(object,sym).enumerable;});}keys.push.apply(keys,symbols);}return keys;}function _objectSpread(target){for(var i=1;i<arguments.length;i++){var source=arguments[i]!=null?arguments[i]:{};if(i%2){ownKeys(Object(source),true).forEach(function(key){_defineProperty(target,key,source[key]);});}else if(Object.getOwnPropertyDescriptors){Object.defineProperties(target,Object.getOwnPropertyDescriptors(source));}else{ownKeys(Object(source)).forEach(function(key){Object.defineProperty(target,key,Object.getOwnPropertyDescriptor(source,key));});}}return target;}const React=__webpack_require__(24072);const{mdx}=__webpack_require__(3905);const{useMDXScope}=__webpack_require__(2197);module.exports=function MDXRenderer(_ref){let{scope,children}=_ref,props=_objectWithoutProperties(_ref,_excluded);const mdxScope=useMDXScope(scope);// Memoize the compiled component
